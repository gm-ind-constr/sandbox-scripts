-- garrysmod/lua/autorun/entity_info.lua
...
elseif CLIENT then
    ...
    local function draw_entity_info()
        ...
        local pos_text = string.format("%.2f, %.2f, %.2f", entity_info_data.pos.x, entity_info_data.pos.y,
            entity_info_data.pos.z)
        ...
        local ang_text = string.format("%.2f, %.2f, %.2f", entity_info_data.ang.p, entity_info_data.ang.y,
            entity_info_data.ang.r)
